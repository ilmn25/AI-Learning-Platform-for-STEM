      ...
      <div className="mx-auto flex min-h-screen max-w-4xl flex-col items-center justify-center px-6 py-16">
        <div className="w-full text-center">
          ...
          <div className="mb-8 flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-slate-900 text-white shadow-lg dark:bg-white dark:text-slate-900">
        ...
        <div className="mt-12 flex flex-col items-center gap-4">
          <Link
            href={dashboardHref}
            className="rounded-xl bg-slate-900 px-8 py-3 text-base font-semibold text-white hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100"
          >
            Go to Dashboard
          </Link>
          <Link
